...
export class ContextID {
    ...
    async addRule(
        ...
        const url: string = utils.generateURL(baseURL, "/{contextID}/rules/add", req);

        let [reqBodyHeaders, reqBody]: [object, any] = [{}, {}];

        try {
            [reqBodyHeaders, reqBody] = utils.serializeRequestBody(req, "addRuleInput", "json");
        } catch (e: unknown) {
    ...
    async evaluateRules(
        ...
        const baseURL: string = this._serverURL;
        const url: string = utils.generateURL(baseURL, "/{contextID}/evaluate", req);
        ...
        const res: operations.EvaluateRulesResponse = new operations.EvaluateRulesResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
    ...
    async getAllRules(
        ...
        const res: operations.GetAllRulesResponse = new operations.GetAllRulesResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
    ...
    async removeRule(
        ...
        const baseURL: string = this._serverURL;
        const url: string = utils.generateURL(baseURL, "/{contextID}/rules/{id}", req);
        ...
        const res: operations.RemoveRuleResponse = new operations.RemoveRuleResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
    ...
    async replaceRule(
        ...
        try {
            [reqBodyHeaders, reqBody] = utils.serializeRequestBody(req, "replaceRuleInput", "json");
        } catch (e: unknown) {
            if (e instanceof Error) {
                throw new Error(`Error serializing request body, cause: ${e.message}`);
            }
        ...
        const res: operations.ReplaceRuleResponse = new operations.ReplaceRuleResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
